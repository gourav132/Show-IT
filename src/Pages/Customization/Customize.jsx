        ...
        <div className='w-full lg:w-2/5 scroll h-screen overflow-y-scroll flex justify-center items-center'>
            <div className='m-10'>
                ...
                <div className='mb-6 flex w-full'>
                    <div>
                        <h1 className='text-2xl font-light'>Customize your <span className='text-violet-400'>portfoilio</span> in just few steps</h1>
                        <p className='font-light mt-2 text-gray-400'>Effortless elegance. Your skills, our canvas.</p>
                    </div>
                ...
                <div className='bottom-10 right-10 z-10 absolute flex flex-col justify-center items-center gap-4'>
                    ...
                    <button onClick={handleSubmitButton} className='px-4 py-4 bg-green-600 hover:bg-green-700 rounded-full block'><IoMdSave /></button>
                    <button onClick={logout} className='py-4 px-4 rounded-full text-red-400 border-2 border-red-400 hover:text-white hover:bg-red-500 transition-colors block'><IoMdLogOut /></button>
                </div>
