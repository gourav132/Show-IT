  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        className="bg-tertiary p-5 rounded-2xl sm:w-[350px] sm:h-[480px] w-full"
      >
        ...
        <div className="mt-5">
          ...
          <p className="mt-2 text-secondary h-32 overflow-y-scroll no-scrollbar">
            {projectDescription}
          </p>
        </div>
